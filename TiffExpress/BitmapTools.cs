...
namespace TiffExpress
{
    public static class BitmapTools
    {
        ...
        public static EnumerableBitmap<T> Concatenate<T>(params Bitmap<T>[] inputBitmaps)
        {
            ...
            var inputRowsArray = inputBitmaps.Select(t => t.Rows).ToArray();
        ...
        private static IEnumerable<T[]> ConcatenateRows<T>(int outputWidth, int outputHeight, params T[][][] inputBitmapsRows)
        {
